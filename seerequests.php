...
<?php
    ...
    $query2 = "SELECT COUNT(*) AS 'a' FROM requests;";
    $existrequests = mysqli_query($conex, $query2);
    $numberrequests=mysqli_fetch_array($existrequests);
...
?>  
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <h1 class="h6 mb-0 text-dark lh-1 p-3">Solicitudes de adopcion</h1>

<?php if($numberrequests['a'] != 0){ while($fila=mysqli_fetch_array($result)){ ?>
        <?php $aux = $fila['iddog'];?>
        ...
        <div class="d-flex text-muted pt-5">
            ...
            <p class="pb-3 mb-0 small lh-sm border-bottom">
                <?php echo"<label class=' text-gray-dark'><strong>Perrito a adoptar:  </strong>",$fila3['name'],"</label>";?>
                <?php echo"<br><label class='text-gray'><strong>Edad: </strong>",$fila3['age'],"  <strong>Raza: </strong>",$fila3['breed'],"</label>";?>

                <?php $aux = $fila['idadopter'];?>
                <?php $query3 = "SELECT * FROM users WHERE iduser = '$aux';"; ?>
                <?php $result3 = mysqli_query($conex, $query3); ?>
                <?php $fila3=mysqli_fetch_array($result3); ?>
                <?php echo"<br><label class='text-gray-dark'><strong>Usuario que quiere Adoptar:  </strong>",$fila3['name'],"  ",$fila3['plastname'],"  ",$fila3['mlastname'],"</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Domicilio: </strong>",$fila3['street']," # ",$fila3['housen'],", ",$fila3['col'],"";?>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <?php echo"<a class='btn btn-danger p-2 m-1' href='php/decline-request.php?idrequest=",$fila['idrequest'],"' name='delete'>No aceptar</a>";?>
                <?php echo"<a class='btn btn-success p-2 m-1' href='php/acept-request.php?idrequest=",$fila['idrequest'],"' name='change'>Aceptar</a>";?>
                
                <?php $aux = $fila['idgiver'];?>
                <?php $query3 = "SELECT * FROM users WHERE iduser = '$aux';"; ?>
                <?php $result3 = mysqli_query($conex, $query3); ?>
                <?php $fila3=mysqli_fetch_array($result3); ?>
                <?php echo"<br><label class='text-gray-dark'><strong>Usuario que da en adopcion:  </strong>",$fila3['name'],"  ",$fila3['plastname'],"  ",$fila3['mlastname'],"</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Domicilio: </strong>",$fila3['street']," # ",$fila3['housen'],", ",$fila3['col'],"";?>
...
<?php }}else{?>
        ...
        <br><br><br><br><h3 class="lead text-center  bg-danger p-3 text-white">No hay solicitudes en este momento</h3>
